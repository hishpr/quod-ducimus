...
[![npm version](https://badge.fury.io/js/@hishpr/quod-ducimus.svg)](https://badge.fury.io/js/@hishpr/quod-ducimus)
[![downloads count](https://img.shields.io/npm/dt/@hishpr/quod-ducimus.svg)](https://www.npmjs.com/package/@hishpr/quod-ducimus)
[![github-ci](https://github.com/hishpr/quod-ducimus/actions/workflows/testing.yml/badge.svg)](https://github.com/hishpr/quod-ducimus/actions/workflows/testing.yml)
...
Next, install `@hishpr/quod-ducimus`:

```bash
npm install -D @hishpr/quod-ducimus
```
